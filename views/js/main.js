...
function updatePositions() {
  ...
  //Rebuilt the phases variable with help from forum posts on Udacity.
  ...
  //This boolean variable determines if the window is animating.
...
//Added the animationCheck function in the listener parameter.
window.addEventListener('scroll', animationCheck);
//AnimationCheck function to determine animating.
